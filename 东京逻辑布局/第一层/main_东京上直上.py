...
db = client['Tokyo_top_straight_logistic']
...
instance.geneKML(col_Tokyo_tree=col_Tokyo_tree,col_Tokyo_tree_node=col_Tokyo_tree_node,col_map=col_map,file_name='Tokyo_topstraight.kml')