...
col_second_node = client['itdk_level_new']['Tokyo_txt']
file_name = './file/link_Tokyo.kml'
...
paint.head()
db_name = ['Tokyo_logistic','Tokyo_right_logistic','Tokyo_leftdown_logistic','Tokyo_top_logistic','Tokyo_top_straight_logistic','Tokyo_left_logistic']
for name in db_name:
    db = client[name]
