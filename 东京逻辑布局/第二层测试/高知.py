...
col_edge = db_result['gaozhi_edge']
col_point = db_result['gaozhi_point']
col_point_degree = db_result['gaozhi_point_degree']
col_edge_degree = db_result['gaozhi_edge_degree']
col_txt = db_result['gaozhi_txt']
city_info = {'name':'gaozhi','longitude':133.633996,'latitude':  33.614375,'range':63,'degree':1}
instance = SecondTopo()
filename_txt='./file/gaozhi_edge.txt'
filename_kml='./file/gaozhi_第二层.kml'
rec_range = {'left':133.507642,'bottom': 33.458613,'top':33.579482,'right':133.737877}
filename_dire = './file/gaozhi_dire.txt'
